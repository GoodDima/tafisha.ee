...
//			pg_connection_reset($this->_connection);

//			$stts = pg_transaction_status($this->_connection);
//			error_log($stts . ' ' . $sql . "\n", 3, '/tmp/my_sql.log');
			...
			if ($type === Database::INSERT)
			{
			    ...
			    elseif (pg_transaction_status($this->_connection) !== PGSQL_TRANSACTION_INTRANS AND $insert_id = pg_send_query($this->_connection, 'SELECT LASTVAL()'))
			    {
